...
void Demo::BuildTexturedCube()
{
	...
	float vertices[] = {
		...
		// front
		-1.5, -0.5, 0.5, 0, 0, 0.0f,  1.0f,  1.0f, // 0
		1.5, -0.5, 0.5, 1, 0,  0.0f,  1.0f,  1.0f, // 1
		1.5,  0.5, 0.5, 1, 1,  0.0f,  1.0f,  1.0f, // 2
		-1.5,  0.5, 0.5, 0, 1, 0.0f,  1.0f,  1.0f, // 3
		...
		-1.5, -0.5,  0.5, 0, 1, 0.0f,  -1.0f,  0.0f, // 23
	};
